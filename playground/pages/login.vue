  ...
  <div class="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0b1120] px-4 py-8">
    ...
    <div class="relative z-10 flex w-full max-w-sm flex-col items-center gap-6">
      ...
      <div class="flex flex-col items-center gap-3 text-center">
        <div class="animate-pulse-glow flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-knpi-600 to-knpi-500 shadow-knpi">
          <div class="flex h-[68px] w-[68px] items-center justify-center rounded-full bg-[#0b1120]">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 64 64" fill="none">
              <path d="M32 4L8 16V34C8 47.3 18.4 59.8 32 63C45.6 59.8 56 47.3 56 34V16L32 4Z" fill="url(#g1)" />
              <text x="32" y="37" text-anchor="middle" font-family="system-ui,sans-serif" font-size="11" font-weight="800" fill="white" letter-spacing="0.5">KNPI</text>
              <defs>
                <linearGradient id="g1" x1="8" y1="4" x2="56" y2="63" gradientUnits="userSpaceOnUse">
                  <stop offset="0%" stop-color="#1a63c8" />
                  <stop offset="100%" stop-color="#3070f0" />
                </linearGradient>
              </defs>
            </svg>
          </div>
        ...
        <div>
          <h1 class="text-2xl font-extrabold tracking-tight text-white">KNPI Langsa</h1>
